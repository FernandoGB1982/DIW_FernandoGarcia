...
<body>
    ...
    <main>
        <div class="container-xl col-md-4">
            <h2 class="text-center m-4">Inicia Sesión / Crear Cuenta</h2>
            
            <!-- Formulario de Iniciar Sesión -->
            <form id="loginForm" method="post" action="iniciar_sesion.php">
                ...
                <div class="container-xl text-center">
                    <button type="submit" class="btn btn-primary text-white text-uppercase fs-6 mt-4" id="loginButton">Iniciar Sesión</button>
                </div>
            </form>

            <!-- Botón para mostrar el formulario de Crear Cuenta -->
            <hr>
            <form  method="post" action="crear_usuario.php">
                <div class="container-xl text-center">
                            <button type="submit" class="btn btn-success text-white text-uppercase fs-6" >Crear Cuenta</button>
                </div>
            </form>
